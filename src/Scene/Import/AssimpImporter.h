...
namespace Ciri
{
    ...
    private:
        ...
        static void ProcessAnimation(const aiScene* scene, const aiAnimation* assimp_anim, const S<SceneNode>& container, std::map<std::string, BoneInfo>& boneinfomap, int& bonecounter);
